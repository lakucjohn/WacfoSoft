...
<div class="container">
    <div id="backup" class="tab-pane active show">
        ...
        <form action="<?php echo base_url('BackupAndRestore/Backup/BackItup/backup'); ?>" method="post">
            <button type="submit" name="backup" class="btn btn-lg btn-primary">Back up your company data now</button>
