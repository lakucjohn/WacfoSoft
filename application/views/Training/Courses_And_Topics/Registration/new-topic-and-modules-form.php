...
<div class="card w-100">
                        ...
                        <td colspan="2">
                            <div class="row">
                                ...
                                <div class="col-md-3" style="margin-bottom: 0.2rem; font-size: 12px;">
                                    <input type="checkbox" name="target_group" id="target_group" value="' . $row->ID . '" /> ' . $row->CATEGORYNAME . '
                                </div>
                            ';
    ...
    <div class="row">
        <div class="col-md-12" style="text-align: center;">
            <button type="button" class="btn btn-primary btn-md" onclick="save_information();">Register Course and
                Modules
            </button>
        </div>
...
//        alert(module_data);
        if ($('#modules_table tr').length === 2) {
            ...
            $.ajax({
                url: "<?php echo base_url('Training/courses/get_and_create_modules'); ?>",
                data: {module_data: module_details, course_details: course_details},
                type: 'post',
