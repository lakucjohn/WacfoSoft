...
<div class="row">
    ...
    <div class="col-md-12">
        <table class="table table-bordered table-responsive">
            ...
            <tr>
                <td>
                    <div class="col-md-12">Total savings per each group</div>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <div class="col-md-12">Amount Loan out</div>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <div class="col-md-12">Total amount paid back</div>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <div class="col-md-12">Interest paid per group</div>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <div class="col-md-12">Issues Identified</div>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <div class="col-md-12">Action taken</div>
                </td>
                <td>
