...
<div class="card w-100">
    ...
    <div class="document-part-content">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <input name="group_id" id="group_id" class="form-control" value="<?php echo $group_id; ?>"/><br>
                ...
                <input type="text" name="name_of_the_group" id="name_of_the_group" class="form-control"
                       value="<?php echo $group_name; ?>" disabled/>
                    ...
                    <td style="width: 60%;">
                        <table class="table table-bordered table-responsive">
                            <tr>
                                ...
                                <td style="width: 30%;">
                                    <div class="col-md-12">
                                        How many children between 7-18 years are attending school in your group? Please
                                        categorize them by their level of vulnerability indicated.<br>
                    ...
                    <td>
                        <table class="table table-bordered table-responsive">
                            <tr>
                                <td style="width: 20%;">
                                    <div class="col-md-12">
                                        Q10 - How many times do you provide meals to your children aged 0-18 years per
                                        day?<br>
                                        <br>
    ...
    <div id="production_tables">
        <?php
        if (isset($production_tables)) {
            echo $production_tables;
        }
        ?>
    </div>
