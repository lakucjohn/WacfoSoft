...
//            print_r($field_data);
    ...
    public function edit()
    {
        ...
        $data = array(
            'title' => 'Edit Porticus Baseline Assessment Record',
        );
        $record_id = $this->uri->segment(3);
        $data['default_value_array'] = $this->porticusBaseline_model->fetch_single_row_data_to_edit($record_id);
...
//        $this->form_validation->set_rules('help_required_from_the_organisation', 'What do you want the organization to help you with', 'required');
        ...
        if ($this->form_validation->run() == FALSE) {
            $this->template->load('default', 'Miscellaneous/Surveys/Modification/porticus-baseline-survey-questionnaire-edit', $data);
...
//            print_r($field_data);
            ...
            $result = $this->porticusBaseline_model->update_record($record_id, $field_data);
...
//        $html = '<h2>Data</h2>';
    ...
    public function filter_data(){
        ...
        $this->template->load('default', 'Miscellaneous/Surveys/Data/filter-data', $data);
    }
